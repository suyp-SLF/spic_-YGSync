...
//去重
public class SupplierCodeNotRepeat extends AbstractOperationServicePlugIn {
	...
	private void getBill(Object societycreditcode, Object pkid) throws Exception {
		...
		DynamicObject[] dy = BusinessDataServiceHelper.load("bd_bizpartner", "id,iscustomer,issupplier", filters);
		...
		for (DynamicObject dynamicObject : dy) {
			...
			DynamicObject result = BusinessDataServiceHelper.loadSingle("bd_supplier", "id,bizpartner", filters1);
			if (result != null) {
